<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.omeryaylaalti.project.dao.ZiyaretciMesajDAO"%>
<%@ page import="com.omeryaylaalti.project.model.ZiyaretciMesajlar"%>
<%
	String mesajid = request.getParameter("mesajid");
	ZiyaretciMesajlar mesaj = new ZiyaretciMesajDAO().getirId(mesajid);
	...
	<div class="right content-page">
		...
		<div class="body content rows scroll-y">
			...
			<div class="page-heading animated fadeInDownBig">
				<h1>Ziyaretci Mesaj İşlemleri</h1>
			</div>
			<!-- End page header -->
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Gelen Mesajları Cevapla</strong>
					</h2>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="mesajGonder" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Mesaj Id:</td>
										<td>${mesaj.mesajid}<input type="hidden" name="mesajid"
											value="${mesaj.mesajid}" /></td>
									</tr>
									<tr>
										<td>Gönderen Adı:</td>
										<td><input type="text" name="gonderenname"
											value="${mesaj.gonderenname}" /></td>
									</tr>
									<tr>
										<td>Gönderen E-mail Adresi:</td>
										<td><input type="text" name="gonderenemail"
											value="${mesaj.gonderenemail}" /></td>
									</tr>
									<tr>
										<td>Mesajınızın Konusu:</td>
										<td><input type="text" name="mesajkonu"/></td>
									</tr>
									<tr>
										<td>Mesaj İçeriği:</td>
										<td>
										<textarea class="form-control" name="mesajicerik" rows="5" id="comment"></textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td><input type="submit" value="Mesaj Gönder"></td>
									</tr>
								</table>
