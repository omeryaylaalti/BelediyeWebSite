		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Haber Görüntüleme Tablosu </strong>
					</h2>
					<div class="additional-btn">
						...
						<ul class="dropdown-menu pull-right animated half fadeInDown"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="adminHaberEkle.jsp">Tabloya Veri Ekle</a></li>
						</ul>
							...
							<table data-sortable="" class="table table-striped"
								...
								<tbody>
									<c:forEach var="urun" items="${listUrun.rows}">
										<tr>
											<td><c:out value="${urun.haberid}" /></td>
											<td><c:out value="${urun.haberphoto}"/></td>
											<td><c:out value="${urun.haberdate}" /></td>
											<td><c:out value="${urun.habername}" /></td>
											<td><c:out value="${urun.habercomment}" /></td>
											<td><a href=adminhaberGuncelle.jsp?id=${urun.haberid}>Güncelle</a></td>
											<td><a href=habersil?haberid=${urun.haberid}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
