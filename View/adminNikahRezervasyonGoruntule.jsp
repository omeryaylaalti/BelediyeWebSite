		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Nikah Randevuları Tablosu </strong>
					</h2>
					<div class="additional-btn">
						...
						<ul class="dropdown-menu pull-right animated half fadeInDown"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="adminNikahTarihSorgula.jsp">Tabloya Veri Ekle</a></li>
						</ul>
								...
								<tbody>
									<c:forEach var="urun" items="${listUrun.rows}">
										<tr>
											...
											<td><c:out value="${urun.nikahid}" /></td>
											<td><c:out value="${urun.nikahdate}" /></td>
											<td><c:out value="${urun.nikahtime}" /></td>
											<td><c:out value="${urun.erkekname}" /></td>
											<td><c:out value="${urun.bayanname}" /></td>
											<td><c:out value="${urun.erkektckimlik}" /></td>
											<td><c:out value="${urun.bayantckimlik}" /></td>
											<td><c:out value="${urun.rezervasyon_email}" /></td>
											<td><a
												href=adminnikahGuncelle.jsp?nikahId=${urun.nikahid}>Güncelle</a></td>
											<td><a href=nikahsil?nikahid=${urun.nikahid}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
