	...
	<div class="right content-page">
		...
		<div class="body content rows scroll-y">
			...
			<div class="page-heading animated fadeInDownBig">
				<h1>Düğün Salonu Randevuları Yönetimi</h1>
			</div>
			<!-- End page header -->
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Düğün Randevuları Görüntüleme </strong>
					</h2>
							...
							<table data-sortable="" class="table table-striped"
								...
								<thead>
									<tr>
										<th>No</th>
										<th>Tarih</th>
										<th>Düğün Salonu İsmi</th>
										<th>Kiralayan İsim</th>
										<th>Açıklama(Özel nedenler vs.)</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="urun" items="${listUrun.rows}">
										<tr>
											...
											<td><c:out value="${urun.dugunid}" /></td>
											<td><c:out value="${urun.dugundate}" /></td>
											<td><c:out value="${urun.dugunsalonuname}" /></td>
											<td><c:out value="${urun.kiralayanname}" /></td>
											<td><c:out value="${urun.duguncomment}" /></td>
											
											<td><a
												href=adminDugunRandevuGuncelle.jsp?id=${urun.dugunid}>Güncelle</a></td>
											<td><a href=dugunRandevusil?id=${urun.dugunid}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
