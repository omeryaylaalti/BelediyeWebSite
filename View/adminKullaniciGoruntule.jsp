		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Kullanıcı Görüntüleme Tablosu </strong>
					</h2>
					<div class="additional-btn">
						...
						<ul class="dropdown-menu pull-right animated half fadeInDown"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="register.jsp">Tabloya Veri Ekle</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1"
								...
								<tbody>
									<c:forEach var="urun" items="${listUrun.rows}">
										<tr>
											...
											<td><c:out value="${urun.name}" /></td>
											<td><c:out value="${urun.username}" /></td>
											<td><c:out value="${urun.email}" /></td>
											<td><c:out value="${urun.pass}" /></td>
											<td><c:out value="${urun.phone}" /></td>
											<td><a href=adminkullaniciGuncelle.jsp?id=${urun.id}>Güncelle</a></td>
											<td><a href=kullanicisil?id=${urun.id}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
