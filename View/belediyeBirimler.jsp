				...
				<div class="box-info full animated fadeInDown">
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="BirimEkleServlet" method="GET">
								<table data-sortable="" class="table table-striped"
									...
									<tbody>
										...
										<th><input type="submit" value="Birim Ekle" /></th>
									</tbody>
								</table>
							</form>
						</div>
								...
								<tbody>
									<c:forEach var="urun" items="${listUrun.rows}">
										<tr>
											...
											<td><a href=birimGuncelle.jsp?id=${urun.birimid}>Güncelle</a></td>
											<td><a href=birimsil?id=${urun.birimid}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
