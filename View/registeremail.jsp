		...
		<div class="full-content-center animated fadeInDownBig">
			...
			<div class="login-wrap">
				<div class="box-info">
					...
					<form role="form" name="myForm" action="EmailDogrula" method="get">
						<div class="form-group login-input">
							<i class="fa fa-envelope overlay"></i> <input type="email"
								name="email" id="email" class="form-control text-input"
								placeholder="E-mail Adresinizi Giriniz.." required>
						</div>
						<div class="durum" align="center"></div>
						<button type="submit" class="btn btn-success btn-block">
							<i class="fa fa-rocket"></i>Kod Gönder
						</button>
					</form>
				</div>
				<p class="text-center">
							...
							$("input[id=email]")
									.keyup(
											function() {
												...
												if (desen.test(eposta)) {
													$(".durum")
															.html(
																	"<font color='green'>E-Posta Doğru</font>");
												} else {
													$(".durum")
															.html(
																	"<font color='red'>E-Posta Yanlış</font>");
												}
											});
