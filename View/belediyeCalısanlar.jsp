	...
	<div class="right content-page">
		...
		<div class="body content rows scroll-y">
			...
			<div class="page-heading animated fadeInDownBig">
				<h1>Belediye Çalışanları Listesi</h1>
			</div>
			<!-- End page header -->
				...
				<div class="box-info full animated fadeInDown">
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form class="form-horizontal" role="form" action="calisanEkle">
								<div class="form-group">
									<label class="col-sm-2 control-label">Çalışan ID</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" name="calisanid"
											placeholder="ID" required>
									</div>
								</div>
								<div class="form-group">
									<label for="input-text-help" class="col-sm-2 control-label">Çalışan
										İsim-Soyisim :</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="calisanname"
											id="input-text-help" required>
									</div>
								</div>
								<div class="form-group">
									<label for="input-text-help" class="col-sm-2 control-label">Çalışan
										Bağlı Olduğu Kurum</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="calisanbirim"
											id="input-text-help" required>
									</div>
								</div>
								<div class="form-group">
									<label for="input-text-help" class="col-sm-2 control-label">Çalışan
										Nufusa Kayıtlı Olduğu İl</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="calisanil"
											id="input-text-help" required>
									</div>
								</div>
								<div class="form-group">
									<label for="input-text-help" class="col-sm-2 control-label">Çalışan
										Tc Kimlik</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="calisantc"
											id="input-text-help" required>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Açıklama(Özel
										Durum vs.)</label>
									<div class="col-sm-10">
										<textarea type="text" class="summernote" name="calisancomment"></textarea>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="submit" class="btn btn-success">Çalışan
											Ekle</button>
										&nbsp&nbsp <a class="btn btn-primary md-trigger"
											href="calisanlariGoruntule.jsp" data-modal="form-modal">Çalışanları
											Görüntüle</a>
