...
<%
	...
	BelediyeBirim birim = new BelediyeBirimDAO().getirId(id);
		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Belediye Birimleri Yönetimi</strong>
					</h2>
					<div class="additional-btn">
						...
						<ul class="dropdown-menu pull-right animated half fadeInDown"
							...
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="#">Tabloyu Güncelle</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="belediyeBirimSil.jsp">Tablodan Veri Sil</a></li>
						</ul>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="guncelle" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Birim Id:</td>
										<td>${birim.birimid}<input type="hidden" name="id"
											value="${birim.birimid}" /></td>
									</tr>
									<tr>
										<td>Birim Adı:</td>
										<td><input type="text" name="adi"
											value="${birim.birimname}" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
