	...
	<div class="right content-page">
		...
		<div class="body content rows scroll-y">
			...
			<div class="page-heading animated fadeInDownBig">
				<h1>Haber Görüntüleme İşlemleri</h1>
			</div>
			<!-- End page header -->
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Site Haber Ekleme Paneli</strong>
					</h2>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="haberekleme" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Haber Id:</td>
										<td><input type="number" name="haberid" required /></td>
									</tr>
									<tr>
										<td>Haber Başlığı:</td>
										<td><input type="text" name="habername" value="" required /></td>
									</tr>
									<tr>
										<td>Haber Ekleme Tarihi:</td>
										<td><input type="date" name="haberdate" /></td>
									</tr>
									<tr>
										<td>Haber Açıklaması:</td>
										<td><textarea class="note" name="habercomment"></textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td><input type="submit" class="btn btn-default" value="Haber Ekle">&nbsp&nbsp<a class="btn btn-primary md-trigger"
										href="adminHaberleriGoruntule.jsp" data-modal="form-modal">Haberleri
										Görüntüle</td></td>
