...
<%
	...
	HaberEkle haber = new HaberEkleDAO().getirId(id);
		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Site Haberleri Yönetimi</strong>
					</h2>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="haberGuncelle" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Haber Id</td>
										<td>${haber.haberid}<input type="hidden" name="haberid"
											value="${haber.haberid}" /></td>
									</tr>
									<tr>
										<td>Haber Tarihi</td>
										<td><input type="date" name="haberdate"
											value="${haber.haberdate}" /></td>
									</tr>
									<tr>
										<td>Haber Başlığı</td>
										<td><input type="text" name="habername"
											value="${haber.habername}" /></td>
									</tr>
									<tr>
										<td>Haber Açıklaması</td>
										<td><input type="text" name="habercomment"
											value="${haber.habercomment}" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td><input type="submit" class="btn btn-default" value="Güncelle"></td>
									</tr>
								</table>
