...
<%
	...
	NikahRandevu nikah = new NikahRandevuDAO().getirId(id);
	request.setAttribute("nikahs", nikah);
%>
		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Nikah Randevu Güncelleme Ekranı</strong>
					</h2>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="nikahGuncelle" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Nikah Id:</td>
										<td>${nikahs.nikahId}<input type="hidden" name="nikahid"
											value="${nikahs.nikahId}" /></td>
									</tr>
									<tr>
										<td>Nikah Tarihi:</td>
										<td><input type="text" name="nikahdate"
											value="${nikahs.nikahdate}"/></td>
									</tr>
									<tr>
										<td>Nikah Saati:</td>
										<td><input type="text" name="nikahtime"
											value="${nikahs.nikahtime}" /></td>
									</tr>
									<tr>
										<td>Erkek İsmi:</td>
										<td><input type="text" name="erkekname"
											value="${nikahs.erkekname}" /></td>
									</tr>
									<tr>
										<td>Bayan İsmi:</td>
										<td><input type="text" name="bayanname"
											value="${nikahs.bayanname}" /></td>
									</tr>
									<tr>
										<td>Erkek Tc Kimlik No:</td>
										<td><input type="text" name="erkektckimlik"
											value="${nikahs.erkektckimlik}" /></td>
									</tr>
									<tr>
										<td>Bayan Tc Kimlik No:</td>
										<td><input type="text" name="bayantckimlik"
											value="${nikahs.bayantckimlik}" /></td>
									</tr>
									<tr>
										<td>Rezervasyon_Email:</td>
										<td><input type="text" name="email"
											value="${nikahs.rezervasyon_email}" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
