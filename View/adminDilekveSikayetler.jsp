		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Dilek ve Şikayet Görüntüleme </strong>
					</h2>
							...
							<table data-sortable="" class="table table-striped"
								...
								<tbody>
									<c:forEach var="urun" items="${listUrun.rows}">
										<tr>
											<td><c:out value="${urun.sikayetid}" /></td>
											<td><c:out value="${urun.sikayetsubject}" /></td>
											<td><c:out value="${urun.sikayetcomment}" /></td>
											<td><a href=sikayetsil?id=${urun.sikayetid}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
