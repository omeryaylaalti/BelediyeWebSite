<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.omeryaylaalti.project.dao.DugunSalonuSecimDAO"%>
<%@ page import="com.omeryaylaalti.project.model.DugunSalonuSecimi"%>
<%
	String id = request.getParameter("id");
	DugunSalonuSecimi dugun = new DugunSalonuSecimDAO().getirId(id);
	request.setAttribute("dugun", dugun);
%>
	...
	<div class="right content-page">
		...
		<div class="body content rows scroll-y">
			...
			<div class="page-heading animated fadeInDownBig">
				<h1>Düğün Salonu Yönetim İşlemleri</h1>
			</div>
			<!-- End page header -->
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Düğün Salonu Randevuları Güncelleme</strong>
					</h2>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="dugunRandevuGuncelle" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Düğün Id:</td>
										<td>${dugun.dugunid}<input type="hidden" name="dugunid"
											value="${dugun.dugunid}" /></td>
									</tr>
									<tr>
										<td>Düğün Tarihi:</td>
										<td><input type="text" name="dugundate"
											value="${dugun.dugundate}" /></td>
									</tr>
									<tr>
										<td>Düğün Salonu İsmi:</td>
										<td><input type="text" name="dugunsalonuname"
											value="${dugun.dugunsalonuname}" /></td>
									</tr>
									<tr>
										<td>Kiralayan İsim:</td>
										<td><input type="text" name="kiralayanname"
											value="${dugun.kiralayanname}" /></td>
									</tr>
									<tr>
										<td>Açıklama(Özel neden vs.):</td>
										<td><input type="text" name="duguncomment"
											value="${dugun.duguncomment}" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
