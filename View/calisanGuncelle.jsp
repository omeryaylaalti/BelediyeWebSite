<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.omeryaylaalti.project.dao.BelediyeCalisanlarDAO"%>
<%@ page import="com.omeryaylaalti.project.model.BelediyeCalisanlar"%>
<%
	String id = request.getParameter("calisanid");
	BelediyeCalisanlar calisan = new BelediyeCalisanlarDAO().getirId(id);
		...
		<div class="body content rows scroll-y">
			...
			<div class="row">
				<div class="box-info full animated fadeInDown">
					<h2>
						<strong>Belediye Çalışanları Yönetimi</strong>
					</h2>
					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<form action="calisanGuncelle" method="get">
								<table data-sortable="" class="table table-striped"
									data-sortable-initialized="true">
									<tr>
										<td>Çalışan Id:</td>
										<td>${calisan.calisanid}<input type="hidden"
											name="calisanid" value="${calisan.calisanid}" /></td>
									</tr>
									<tr>
										<td>Çalışanın Adı:</td>
										<td><input type="text" name="calisanname"
											value="${calisan.calisanname}" /></td>
									</tr>
									<tr>
										<td>Çalışanın Çalıştığı Birimi:</td>
										<td><input type="text" name="calisanbirim"
											value="${calisan.calisanbirim}" /></td>
									</tr>
									<tr>
										<td>Çalışanın Nufusa Kayıtlı Olduğu İl:</td>
										<td><input type="text" name="calisanil"
											value="${calisan.calisanil}" /></td>
									</tr>
									<tr>
										<td>Çalışan Tc:</td>
										<td><input type="text" name="calisantc"
											value="${calisan.calisantc}" /></td>
									</tr>
									<tr>
										<td>Çalışan Açıklama(Özel Durum vs.):</td>
										<td><input type="text" name="calisanaciklama"
											value="${calisan.calisancomment}" /></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
