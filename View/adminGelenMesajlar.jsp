					...
					<div id="sales-report" class="collapse in">
						<div class="table-responsive">
							<table data-sortable="" class="table table-striped"
								...
								<tbody>
									<c:forEach var="mesaj" items="${listUrun.rows}">
										<tr>
											<td><c:out value="${mesaj.mesajid}" /></td>
											<td><c:out value="${mesaj.gonderenname}" /></td>
											<td><c:out value="${mesaj.gonderenemail}" /></td>
											<td><c:out value="${mesaj.mesajkonu}" /></td>
											<td><c:out value="${mesaj.mesajicerik}" /></td>
											<td><a
												href=adminZiyaretciMesajGonder.jsp?mesajid=${mesaj.mesajid}>Mesajı
													Cevapla</a></td>
											<td><a href=ZiyaretciMesajSil?mesajid=${mesaj.mesajid}>Sil</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
